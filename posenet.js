...
function repTracker(){
  ...
  let angleCountObj = document.getElementById("angleCount")
  angleCountObj.innerHTML = angle.toString()
  ...
  let repCountObj = document.getElementById("repCount")
  repCountObj.innerHTML = reps.toString()
}
